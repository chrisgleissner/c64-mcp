...
import { createPetsciiArt } from "../petsciiArt.js";
...
function decodeSpriteString(value, path) {
...
const spriteArgsSchema = objectSchema({
...
const petsciiImageArgsSchema = objectSchema({
...
async function executeGenerateSprite(rawArgs, ctx) {
    try {
...
async function executeRenderPetscii(rawArgs, ctx) {
    try {
...
async function executeCreatePetscii(rawArgs, ctx) {
    try {
...
export const graphicsOperationHandlers = {
