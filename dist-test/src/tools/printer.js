...
import { ToolExecutionError, ToolValidationError, toolErrorResult, unknownErrorResult, } from "./errors.js";
...
const printTextArgsSchema = objectSchema({
...
const commodoreBitmapArgsSchema = objectSchema({
...
const epsonBitmapArgsSchema = objectSchema({
...
const commodoreDllCharSchema = objectSchema({
...
const commodoreDllArgsSchema = objectSchema({
...
function validateEpsonDensity(args) {
