...
import { listKnowledgeResources, readKnowledgeResource, } from "./rag/knowledgeIndex.js";
...
function renderPlatformStatusMarkdown() {
    ...
    lines.push("> Switching platforms currently requires restarting the MCP server with an updated configuration.");
    return lines.join("\n");
}
async function logConnectivity(client, baseUrl) {
...
function toCallToolResult(result) {
    const base = { content: result.content };
...
function toPromptMessage(segment) {
