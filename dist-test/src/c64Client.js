...
export class C64Client {
    constructor(baseUrl) {
        this.http = createLoggingHttpClient({ baseURL: baseUrl, timeout: 10000 });
    ...
    async runPrg(prg) {
        try {
            if (process.env.C64_TEST_TARGET === "mock") {
                ...
                const response = await this.api.v1.runnersRunPrgCreate(":run_prg", payload, {
    ...
    async modplayFile(path) {
        try {
            const facade = await this.facadePromise;
            if (!facade.modplayFile)
                throw new Error("modplay not supported by selected backend");
    ...
    async writeMemory(addressInput, bytesInput) {
        try {
            ...
            try {
                ...
                if (!(facadeError instanceof Error) || facadeError.code !== "UNSUPPORTED") {
                    throw facadeError;
                }
            }
            let response;
            if (dataBuffer.length <= 128) {
                ...
                const post = await this.api.v1.machineWritememCreate(":writemem", { address: addrStr }, Buffer.from(dataBuffer), { headers: { "Content-Type": "application/octet-stream" } });
                response = post.data;
            }
            return {
                success: true,
    ...
    async menuButton() {
        try {
            ...
            const facade = await this.facadePromise;
            return await facade.menuButton();
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async debugregRead() {
        try {
            if (process.env.C64_TEST_TARGET === "mock") {
                ...
                return { success: true, value: res.data.value, details: res.data };
            }
            const facade = await this.facadePromise;
            return await facade.debugregRead();
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async debugregWrite(value) {
        try {
            ...
            const facade = await this.facadePromise;
            return await facade.debugregWrite(value);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async drivesList() {
        const facade = await this.facadePromise;
        return facade.drivesList();
    }
    async driveMount(drive, imagePath, options) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveMount(drive, imagePath, options);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async driveRemove(drive) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveRemove(drive);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async driveReset(drive) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveReset(drive);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async driveOn(drive) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveOn(drive);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async driveOff(drive) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveOff(drive);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async driveLoadRom(drive, path) {
        try {
            if (!drive || !path)
                throw new Error("Drive and path are required");
            if (process.env.C64_TEST_TARGET === "mock") {
    ...
    async driveSetMode(drive, mode) {
        try {
            const facade = await this.facadePromise;
            return await facade.driveSetMode(drive, mode);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    }
    async streamStart(stream, ip) {
        try {
            const facade = await this.facadePromise;
            return await facade.streamStart(stream, ip);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async streamStop(stream) {
        try {
            const facade = await this.facadePromise;
            return await facade.streamStop(stream);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async configSet(category, item, value) {
        try {
            const facade = await this.facadePromise;
            return await facade.configSet(category, item, value);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async configBatchUpdate(payload) {
        try {
            const facade = await this.facadePromise;
            return await facade.configBatchUpdate(payload);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async configLoadFromFlash() {
        try {
            const facade = await this.facadePromise;
            return await facade.configLoadFromFlash();
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async configSaveToFlash() {
        try {
            const facade = await this.facadePromise;
            return await facade.configSaveToFlash();
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async configResetToDefault() {
        try {
            const facade = await this.facadePromise;
            return await facade.configResetToDefault();
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    async filesInfo(path) {
        const facade = await this.facadePromise;
        return facade.filesInfo(path);
    }
    async filesCreateD64(path, options) {
        try {
            const facade = await this.facadePromise;
            return await facade.filesCreateD64(path, options);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    }
    async filesCreateD71(path, options) {
        try {
            const facade = await this.facadePromise;
            return await facade.filesCreateD71(path, options);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    }
    async filesCreateD81(path, options) {
        try {
            const facade = await this.facadePromise;
            return await facade.filesCreateD81(path, options);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    }
    async filesCreateDnp(path, tracks, options) {
        try {
            const facade = await this.facadePromise;
            return await facade.filesCreateDnp(path, tracks, options);
        }
        catch (error) {
            return { success: false, details: this.normaliseError(error) };
        }
    ...
    hzToSidFrequency(hz, system = "PAL") {
        const phi2 = system === "PAL" ? 985248 : 1022727;
...
function buildPetsciiScreenBasic(opts) {
...
function chunkString(input, maxLen) {
...
function escapeBasicQuotes(input) {
...
export function buildEpsonBitmapBasicProgram(opts) {
    ...
    const n = len & 0xff;
    const m = (len >> 8) & 0xff;
    const mode = (opts.mode ?? "K").toUpperCase();
    const repeats = Math.max(1, Math.floor(opts.repeats ?? 1));
    const timesPerLine = Math.max(1, Math.floor(opts.timesPerLine ?? 4));
    function modeCode(mo) {
        const map = { K: 75, L: 76, Y: 89, Z: 90 };
        return map[mo] ?? null;
    }
    const lines = [];
    lines.push(`10 OPEN1,4`);
